...
class ClientCoreData(CompositeType):
    ...
    def __init__(self, readLen = None):
        ...
        self.colorDepth = UInt16Le(ColorDepth.RNS_UD_COLOR_16BPP_555)
        self.sasSequence = UInt16Le(Sequence.RNS_UD_SAS_DEL)
        self.kbdLayout = UInt32Le(KeyboardLayout.US)
        self.clientBuild = UInt32Le(3790)
        self.clientName = String("mstsc" + "\x00"*10, readLen = CallableValue(32), unicode = True)
        ...
        self.postBeta2ColorDepth = UInt16Le(ColorDepth.RNS_UD_COLOR_16BPP_555, optional = True)
        ...
        self.supportedColorDepths = UInt16Le(Support.RNS_UD_16BPP_SUPPORT | Support.RNS_UD_32BPP_SUPPORT, optional = True)
